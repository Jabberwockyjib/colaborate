...
## In Progress
_(nothing in-flight — Phase 2 shipped cleanly)_

## Next Up

- [ ] **Phase 3** — MCP server (`packages/mcp-server`) exposing feedback to Claude Code

## Phase 3+ (written when Phase 3 lands)
