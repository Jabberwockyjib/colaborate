...
<head>
  ...
  <title>Colaborate E2E Test Page</title>
  <style>
...
<body>
  <div class="hero" id="hero">
    ...
    <p>Cette page simule un site client pour tester le widget Colaborate.</p>
  </div>
  <div class="section">
  ...
  <div class="section">
    ...
    <p>Colaborate s'intègre directement dans votre site web. Le widget permet à vos clients de laisser des retours visuels en annotant directement les éléments de la page.</p>
  ...
  <div class="section">
    ...
    <details style="margin-bottom: 12px;">
      ...
      <p style="color: #666; margin-top: 8px;">Ajoutez simplement le script sur votre page et appelez initColaborate() avec votre configuration.</p>
    </details>
    <details style="margin-bottom: 12px;">
  ...
  <div class="section">
    ...
    <blockquote style="border-left: 4px solid #6366f1; margin: 16px 0; padding: 12px 20px; background: #f9f9ff; border-radius: 0 8px 8px 0;">
      <p style="margin: 0; font-style: italic; color: #444;">"Colaborate a transformé notre processus de relecture avec nos clients. Plus besoin de captures d'écran par email !"</p>
  ...
  <div class="section">
    <h2>Contact</h2>
    <p>Des questions ? Contactez-nous à <a href="#">support@colaborate.develotype.com</a></p>
    <p style="color: #999; margin-top: 40px; text-align: center;">© 2026 Colaborate — Tous droits réservés</p>
  </div>
  <script>
  ...
  <script type="module">
    ...
    const instance = initColaborate({
      endpoint: '/api/colaborate',
      projectName: 'e2e-test',
      forceShow: true,
      accentColor: '#6366f1',
    });
    window.__colaborate = instance;
  </script>
</body>
</html>`;
...
const server = createServer((req, res) => {
  ...
  // API endpoint
  if (url.pathname === "/api/colaborate") {
