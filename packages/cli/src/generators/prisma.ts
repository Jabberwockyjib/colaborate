...
import { COLABORATE_MODELS, type FieldDef, type IndexDef } from "@colaborate/core";
...
/**
 * Sync Colaborate models into an existing Prisma schema.
 *
 ...
 * - User-added fields outside Colaborate's definition are left untouched
 */
