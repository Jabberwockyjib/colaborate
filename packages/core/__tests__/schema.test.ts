...
// ---------------------------------------------------------------------------
// ColaborateFeedback model
// ---------------------------------------------------------------------------

describe("ColaborateFeedback model", () => {
  const model = COLABORATE_MODELS.ColaborateFeedback;
  ...
  it("annotations is a 1-to-many relation to ColaborateAnnotation", () => {
    expect(fields.annotations.type).toBe("ColaborateAnnotation");
    expect(fields.annotations.relation).toBeDefined();
    expect(fields.annotations.relation!.kind).toBe("1-to-many");
    expect(fields.annotations.relation!.model).toBe("ColaborateAnnotation");
  });
...
// ---------------------------------------------------------------------------
// ColaborateAnnotation model
// ---------------------------------------------------------------------------

describe("ColaborateAnnotation model", () => {
  const model = COLABORATE_MODELS.ColaborateAnnotation;
  const fields = model.fields;
  ...
  it("feedback is a many-to-1 relation to ColaborateFeedback with Cascade delete", () => {
    const rel = fields.feedback.relation;
    expect(rel).toBeDefined();
    expect(rel!.kind).toBe("many-to-1");
    expect(rel!.model).toBe("ColaborateFeedback");
