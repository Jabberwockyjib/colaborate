...
import type { ColaborateConfig } from "@colaborate/core";
...
function defaultConfig(overrides: Partial<ColaborateConfig> = {}): ColaborateConfig {
  return {
...
describe("launch", () => {
  ...
  describe("widget DOM structure", () => {
    it("creates a colaborate-widget custom element", () => {
      const instance = launch(defaultConfig());
  ...
  describe("destroy", () => {
    it("removes the colaborate-widget element", () => {
      const instance = launch(defaultConfig());
      instance.destroy();
  ...
  describe("locale", () => {
    it("defaults to French locale", () => {
      ...
      // French ARIA label
      expect(fabBtn.getAttribute("aria-label")).toContain("Colaborate");
    ...
    it("supports English locale", () => {
      ...
      expect(panel.getAttribute("aria-label")).toBe("Colaborate feedback panel");
  ...
  describe("config validation guards", () => {
    it("returns no-op when endpoint is missing", () => {
      const instance = launch({ projectName: "test", forceShow: true } as ColaborateConfig);
    ...
    it("returns no-op when projectName is missing", () => {
      const instance = launch({ endpoint: "/api", forceShow: true } as ColaborateConfig);
