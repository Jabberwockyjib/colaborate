...
const installCommands: Record<PackageManager, string> = {
  npm: "npm install @colaborate/widget @colaborate/adapter-prisma",
  bun: "bun add @colaborate/widget @colaborate/adapter-prisma",
  yarn: "yarn add @colaborate/widget @colaborate/adapter-prisma",
  pnpm: "pnpm add @colaborate/widget @colaborate/adapter-prisma",
};

const setupCommands: Record<PackageManager, string> = {
  npm: "npx @colaborate/cli init",
  bun: "bunx @colaborate/cli init",
  yarn: "yarn dlx @colaborate/cli init",
  pnpm: "pnpm dlx @colaborate/cli init",
};
...
function AnnotateCode() {
  return (
    <code>
      ...
      <span className="text-yellow-300">initColaborate</span>
      <span className="text-gray-300"> {"}"} </span>
      <span className="text-purple-400">from</span>{" "}
      <span className="text-green-400">&apos;@colaborate/widget&apos;</span>
      {"\n"}
      {"\n"}
      <span className="text-yellow-300">initColaborate</span>
      <span className="text-gray-500">({"{"}</span>
      ...
      <span className="text-gray-500">: </span>
      <span className="text-green-400">&apos;/api/colaborate&apos;</span>
      <span className="text-gray-500">,</span>
      {"\n"}
      {"  "}
