#!/usr/bin/env node
// Fixes .d.ts files that reference the unpublished @colaborate/core package.
...
// 1. Rewrite '@colaborate/core' imports to relative './colaborate-core.js'
...
for (const file of dtsFiles) {
  ...
  content = content.replaceAll("'@colaborate/core'", "'./colaborate-core.js'");
  content = content.replaceAll('"@colaborate/core"', '"./colaborate-core.js"');
...
// 2. Copy core's .d.ts files, renaming index.d.ts to colaborate-core.d.ts
const copies = [
  { src: "index.d.ts", dest: "colaborate-core.d.ts" },
